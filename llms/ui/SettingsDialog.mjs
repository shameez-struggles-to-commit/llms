            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
                ...
                <form class="px-6 py-4 overflow-y-auto max-h-[calc(90vh-140px)]" @submit.prevent="save">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="flex items-center">
                                <input type="checkbox" v-model="localSettings.stream"
                                    class="rounded border-gray-300 dark:border-gray-600 text-blue-600 focus:ring-blue-500" />
                                <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">Enable Streaming</span>
                            </label>
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Stream response tokens in real-time as they're generated</p>
                        </div>
                    </div>
                </form>
